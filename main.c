...
void usage()
{
    printf("Error: Invalid syntax\nUsage: netfilter-test <host>\nExample: netfilter-test test.gilgil.net\n");
}
          ...
          struct nfq_data *nfa, void* host)
{
    ...
    if(get_pl>=0){
        ...
        acc_or_drop = netfilter(data, host, host_name,host_len)? NF_ACCEPT : NF_DROP;
        printf("%d\n",acc_or_drop);
    }
